...
```bash
curl -L https://github.com/delixon-labs/delixon-qiloback/releases/download/v0.3.9/qiloback-linux-x64 \
  -o qiloback
chmod +x qiloback
...
```bash
docker pull ghcr.io/delixon-labs/qiloback:0.3.9
docker pull ghcr.io/delixon-labs/qiloback-worker:0.3.9
```
...
helm install qiloback qiloback/qiloback --version 0.3.9
```
